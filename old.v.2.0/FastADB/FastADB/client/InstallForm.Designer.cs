...
namespace FastADB.client
{
	partial class InstallForm
	{
		...
		private System.Windows.Forms.CheckBox cdcardCheckBox;
		...
		private void InitializeComponent()
		{
			...
			this.panel3.Size = new System.Drawing.Size(434, 270);
			...
			this.scriptTextBox.Size = new System.Drawing.Size(429, 268);
			...
			this.label5.Text = "Откроется папка содержащую apk файлы.";
			// 
			// linkLabel4
			// 
			...
			this.panel1.Controls.Add(this.cdcardCheckBox);
			...
			// cdcardCheckBox
			// 
			this.cdcardCheckBox.Location = new System.Drawing.Point(94, 35);
			this.cdcardCheckBox.Name = "cdcardCheckBox";
			this.cdcardCheckBox.Size = new System.Drawing.Size(335, 24);
			this.cdcardCheckBox.TabIndex = 7;
			this.cdcardCheckBox.Text = "Установить пакет на sd-card";
			this.cdcardCheckBox.UseVisualStyleBackColor = true;
			this.cdcardCheckBox.CheckedChanged += new System.EventHandler(this.CdcardCheckBoxCheckedChanged);
			// 
			// button2
			// 
			...
			this.filenameTextBox.Location = new System.Drawing.Point(94, 9);
			...
			this.Text = "ADB: Install - установка apk пакетов на устройство";
			this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.InstallFormFormClosed);
			this.Load += new System.EventHandler(this.InstallFormLoad);
