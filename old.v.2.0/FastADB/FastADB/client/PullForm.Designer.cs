...
namespace FastADB.client
{
	partial class PullForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.label5.Text = "Откроется папка с файлами.";
			// 
			// linkLabel4
			// 
			...
			this.label14.Text = "Добавляет команду удаляющую исходный файл.";
			// 
			// linkLabel7
			// 
			...
			this.linkLabel7.Location = new System.Drawing.Point(3, 217);
			...
			this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.PullFormFormClosed);
			this.Load += new System.EventHandler(this.PullFormLoad);
