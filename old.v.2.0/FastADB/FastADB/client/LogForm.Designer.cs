...
namespace FastADB.client
{
	partial class LogForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.filenameTextBox.Text = "log.txt";
			...
			this.label5.Text = "Откроется папка с логами.";
			// 
			// linkLabel4
			// 
			...
			this.linkLabel4.Text = "Открыть папку с логами";
			...
			this.Name = "LogForm";
			this.Text = "ADB: Log - получить системный лог с устройства.";
			this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.LogFormFormClosed);
