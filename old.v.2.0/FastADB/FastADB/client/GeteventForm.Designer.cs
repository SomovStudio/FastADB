...
namespace FastADB.client
{
	partial class GeteventForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.linkLabel5.Location = new System.Drawing.Point(3, 237);
			...
			this.linkLabel6.Location = new System.Drawing.Point(3, 292);
			...
			this.label5.Text = "Конвертирует полученные события.";
			// 
			// linkLabel4
			// 
			...
			this.folderPcTextBox.Location = new System.Drawing.Point(94, 30);
			this.folderPcTextBox.Name = "folderPcTextBox";
			this.folderPcTextBox.Size = new System.Drawing.Size(299, 20);
			this.folderPcTextBox.TabIndex = 5;
			// 
			// label10
			// 
			...
			this.linkLabel7.Location = new System.Drawing.Point(3, 355);
			...
			this.panel5.Location = new System.Drawing.Point(5, 232);
			...
			this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.GeteventFormFormClosed);
			this.Load += new System.EventHandler(this.GeteventFormLoad);
