...
namespace FastADB.client
{
	partial class ScreenshotForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.linkLabel4.Text = "Открыть папку со скрином";
			...
			this.filenameTextBox.Text = "screen.png";
			...
			this.label14.Text = "Откроется папка с логами.";
			// 
			// linkLabel7
			// 
			...
			this.linkLabel7.Text = "Просмотреть скрин";
			...
			this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.ScreenshotFormFormClosed);
			this.Load += new System.EventHandler(this.ScreenshotFormLoad);
